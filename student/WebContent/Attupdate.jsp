...
<form action="Attupdate1.jsp" method=post><br></form>
...
<%=sub1%> : <input type="text" name="subject1" placeholder="attendance%">
<%=sub2%> : <input type="text" name="subject2" placeholder="attendance%">
<%=sub3%> : <input type="text" name="subject3" placeholder="attendance%">
<%=sub4%> : <input type="text" name="subject4" placeholder="attendance%">
<%=sub5%> : <input type="text" name="subject4" placeholder="attendance%">
