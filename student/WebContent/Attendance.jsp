...
try
{
	...
	con=DriverManager.getConnection("jdbc:mysql://localhost:3306/student","root","golu");
	 Statement s=con.createStatement();
	 ResultSet rs = s.executeQuery("select * from att");
...
<center>
<br>
<%=sub1%>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<%=s1%><br><br><br>
<%=sub2%>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<%=su2%><br><br><br>
<%=sub3%>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<%=s3%><br><br><br>
<%=sub4%>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<%=s4%><br><br><br>
<%=sub5%>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<%=s5%><br><br><br>
 </center>
</form>
</div>
